...
btn_ahas=tk.Button(frame, text="Skill Books", command=lambda:[all_house_skill(), btn_ahas.pack_forget()])
btn_ahasp=tk.Button(frame, text="Spell Tomes", command=lambda:[all_house_spell(), btn_ahasp.pack_forget()])
btn_ahareg=tk.Button(frame, text="Regular Books", command=lambda:[all_house_reg(), btn_ahasp.pack_forget()])
btn_clr_ah=tk.Button(frame, text="Clear", command=lambda:[clear_ah(), btn_clr_ah.pack_forget()])
#################################################CREATE WIDGETS#######################################################
##################################################RUN PROGRAM#######################################################
#LAUNCH DATABASE:
