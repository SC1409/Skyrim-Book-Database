...
class main_win:
    def __init__(self, master):
        ...
        self.txt=tk.Text(self.frame, width=125, exportselection=0)
    ...
    def txt_c2c(self, *args):
        try:
            #self.listbox_houses.config(exportselection=0)
            #self.listbox_rooms.config(exportselection=0)
            self.txt.config(exportselection=1)
            ...
            #self.master.update()          
            #self.listbox_houses.config(exportselection=1)
            self.txt.config(exportselection=0)
            #self.listbox_rooms.config(state='normal')
        except tk.TclError:
            return
    ...
    def search(self, *event):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, result_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, result_dis.to_markdown(index=False))])
...
#############################################CREATE FUNCTIONS FOR ALL HOUSES########################################  
    ...
    def fill_table_all_rooms(self, *args):         
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, all_h_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, all_h_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def all_house_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, all_h_skill_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, all_h_skill_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def all_house_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, all_h_spell_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, all_h_spell_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def all_house_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, all_h_reg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, all_h_reg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
...
###########################################CREATE FUNCTIONS FOR TUNDRA HOMESTEAD#####################################
    ...
    def fill_table_th_rooms(self, *args):            
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thar_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thar_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==1:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbr_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbr_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==2:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thba_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thba_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thar_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, tharas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, tharas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thar_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, tharasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, tharasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thar_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, tharareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, tharareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thbr_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thbr_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbrasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbrasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thbr_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbrareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbrareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thba_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbaas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbaas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thba_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbaasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbaasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def thba_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbaareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, thbaareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
###########################################CREATE FUNCTIONS FOR GOLDENHILLS PLANTATION#####################################       
    ...
    def fill_table_gp_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpar_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpar_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==1:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpbr_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpbr_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==2:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrl_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrl_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==3:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrr_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrr_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpar_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gparas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gparas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    #THIS FUNCTION IS BUTTON ACTIVATED AND FILTERS FOR SKILL BOOKS IN ALL ROOMS IN GOLDENHILLS PLANTATION:
    def gpar_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gparasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gparasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpar_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gparareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gparareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpbr_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpbras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpbras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpbr_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpbrasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpbrasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpbr_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpbrareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpbrareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpsrl_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrlas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrlas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpsrl_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrlasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrlasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpsrl_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrlareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrlareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpsrr_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpsrr_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrrasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrrasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def gpsrr_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrrareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, gpsrrareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
#############################################CREATE FUNCTIONS FOR BREEZEHOME########################################
    ...
    def fill_table_b_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bar_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bar_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==1:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bliv_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bliv_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==2:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blab_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blab_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bar_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, baras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, baras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bar_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, barasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, barasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bar_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, barareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, barareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bliv_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blivas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blivas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bliv_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blivasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blivasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bliv_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blivareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blivareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def blab_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blabas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blabas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def blab_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blabasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blabasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def blab_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blabareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, blabareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
##########################################CREATE FUNCTIONS FOR LAKEVIEW MANOR#######################################
    ...
    def fill_table_lm_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, lm_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, lm_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def lm_skill(self, *args):
        ...
        self.txt.insert(tk.END, lms_dis.to_markdown(index=False))
        lmas_dis_sort=lmas_dis.sort_values('Title')
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, lmas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, lmas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def lm_spell(self, *args):
        ...
        self.txt.insert(tk.END, lmsp_dis.to_markdown(index=False))
        lmasp_dis_sort=lmasp_dis.sort_values('Title')
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, lmasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, lmasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def lm_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, lmareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, lmareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
#########################################CREATE FUNCTIONS FOR BLOODCHILL MANOR######################################
    ...
    def fill_table_bm_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmar_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmar_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==1:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb1_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb1_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==2:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb2_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb2_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==3:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmcr_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmcr_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmar_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmaras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmaras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmar_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmarasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmarasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmar_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmarareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmarareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmmb1_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb1as_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb1as_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmmb1_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb1asp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb1asp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmmb1_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb1areg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb1areg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmmb2_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb2as_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb2as_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmmb2_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb2asp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb2asp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmmb2_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb2areg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmmb2areg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmcr_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmcras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmcras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmcr_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmcrasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmcrasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def bmcr_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmcrareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, bmcrareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
###############################################CREATE FUNCTIONS FOR HENDRAHEIM######################################
    ...
    def fill_table_h_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, har_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, har_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==1:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrl_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrl_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==2:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrr_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrr_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==3:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hda_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hda_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def har_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, haras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, haras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def har_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, harasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, harasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def har_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, harareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, harareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def hbrl_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrlas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrlas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')       
    ...
    def hbrl_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrlasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrlasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')        
    ...
    def hbrl_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrlareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrlareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')        
    ...
    def hbrr_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')        
    ...
    def hbrr_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrrasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrrasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')          
    ...
    def hbrr_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrrareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hbrrareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')            
    ...
    def hda_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hdaas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hdaas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')           
    ...
    def hda_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hdaasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hdaasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')           
    ...
    def hda_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hdaareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hdaareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')         
###############################################CREATE FUNCTIONS FOR HONEYSIDE########################################
    ...
    def fill_table_hs_rooms(self, *args):            
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsar_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsar_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==1:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbr_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbr_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')
            if idx_room==2:
                self.forget_btns()
                self.txt.delete(1.0, tk.END)
                ...
                self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsba_dis_sort.to_markdown(index=False))])
                self.btn_title_abc.grid(row=6, column=0, sticky='news')
                self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsba_dis.to_markdown(index=False))])
                self.btn_title_ind.grid(row=6, column=1, sticky='news')                
    ...
    def hsar_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsaras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsaras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')  
    ...
    def hsar_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsarasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsarasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')  
    ...
    def hsar_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsarareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsarareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')  
    ...
    def hsbr_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbras_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbras_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news') 
    ...
    def hsbr_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbrasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbrasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news') 
    ...
    def hsbr_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbrareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbrareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news') 
    ...
    def hsba_skill(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbaas_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbaas_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news') 
    ...
    def hsba_spell(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbaasp_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbaasp_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
    ...
    def hsba_reg(self, *args):
        ...
        self.btn_title_abc=tk.Button(self.frame, text='Sort Alphabetically', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbaareg_dis_sort.to_markdown(index=False))])
        self.btn_title_abc.grid(row=6, column=0, sticky='news')
        self.btn_title_ind=tk.Button(self.frame, text='Sort by Index', command=lambda:[self.txt.delete(1.0, tk.END), self.txt.insert(tk.END, hsbaareg_dis.to_markdown(index=False))])
        self.btn_title_ind.grid(row=6, column=1, sticky='news')
