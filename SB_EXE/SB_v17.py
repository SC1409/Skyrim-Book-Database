...
class main_win:
    def __init__(self, master):
        ...
        #CREATE BUTTON TO OPEN 'ADD BOOK' WINDOW:
        self.btn_open_movebook=tk.Button(self.frame, text='Change Book', command=self.open_movebook)
        self.btn_open_movebook.grid(row=6, column=2, columnspan=2, sticky='ew')
...
class movebook_win:
    def __init__(self, master):
        ...
        self.frame.grid(row=0, column=0, sticky='news')
        all_books=pd.read_sql_query('SELECT * FROM "My Books"', con)
        self.lbl_movebook_title=tk.Label(self.frame, text='Select Book:')
        self.lbl_movebook_title.grid(row=0, column=0, columnspan=2, sticky='ew')
        ...
        #self.listbox_title.bind('<<ListboxSelect>>', self.select_item)
