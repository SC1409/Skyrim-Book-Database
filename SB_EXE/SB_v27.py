...
#OPEN LISTS.TXT:
mainhouseslist = open('C:/Users/steph/Documents/Python/SB_EXE/list_main_houses.txt', 'r+')
tundraroomslist = open('C:/Users/steph/Documents/Python/SB_EXE/list_main_th_rooms.txt', 'r+')
ablists = open('C:/Users/steph/Documents/Python/SB_EXE/lists_addbook.txt', 'r+')
MHL = []
THR = []
addbooklist = []
#FETCH LISTS OF HOUSES AND ROOMS:
for house in mainhouseslist:
    MHL.append(house)
for room in tundraroomslist:
    THR.append(room)
houses = MHL[0]
th_rooms = THR[0].split(',')
##gp_rooms = mainlist[:][3]
##b_rooms = mainlist[:][4]
##lm_rooms = mainlist[:][5]
##bm_rooms = mainlist[:][6]
##h_rooms = mainlist[:][7]
##hs_rooms = mainlist[:][8]
##houses_addbook = addbooklist[0]
##th_rooms_addbook = addbooklist[1]
##gp_rooms_addbook = addbooklist[2]
##b_rooms_addbook = addbooklist[3]
##lm_rooms_addbook = addbooklist[4]
##bm_rooms_addbook = addbooklist[5]
##h_rooms_addbook = addbooklist[6]
##hs_rooms_addbook = addbooklist[7]
...
###############################################CREATE FUNCTIONS FOR HONEYSIDE########################################
    ...
    def addhouse(self, *args):
        ...
        mainhouseslist.write(f",{NEW_HOUSE}") 
...
con.commit()
con.close()
mainhouseslist.close()
tundraroomslist.close()
