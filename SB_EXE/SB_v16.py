...
class main_win:
    def __init__(self, master):
        ...
        self.btn_open_addbook.grid(row=5, column=0, sticky='w')
...
class addbook_win:
    ...
    def addbook(self, *args):
        ...
        #all_books=pd.concat([all_books, new_row], ignore_index=True)
        #all_books._append(new_row, ignore_index=True)
        con.commit()
        #############ADD CODE HERE TO CLOSE WINDOW WHEN DONE###################
