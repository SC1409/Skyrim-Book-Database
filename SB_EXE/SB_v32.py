...
class main_win:
    def __init__(self, master):
        ...
        self.listbox_houses=tk.Listbox(self.frame, listvariable=Houses_main, bg='white', font='Ariel', fg='black', exportselection=False)
...
class addbook_win:
    def __init__(self, master):
        ...
        self.lbl_houses=tk.Label(self.frame, text='Select House:')
        self.lbl_houses.grid(row=1, column=0, sticky='ew')
        self.listbox_houses=tk.Listbox(self.frame, listvariable=Houses_add_move, bg='white', font='Ariel', fg='black')
