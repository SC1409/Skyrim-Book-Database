...
class main_win:
    def __init__(self, master):
        ...
        self.lbl_search.grid(row=6, column=1, sticky='ew')
        ...
        self.btn_search.grid(row=6, column=3, sticky='e')
        ...
        self.btn_open_addbook.grid(row=0, column=0, columnspan=2, sticky='ew')
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
...
#############################################CREATE FUNCTIONS FOR ALL HOUSES########################################  
    ...
    def fill_table_all_rooms(self, *args):         
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_ahareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def all_house_skill(self, *args):
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_ah.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_ahasp.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_ahareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def all_house_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_ah.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_ahas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_ahareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def all_house_reg(self, *args):
        ...
        self.btn_clr_ah.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_ahas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_ahasp.grid(row=5, column=0, columnspan=2, sticky='ew')
...
###########################################CREATE FUNCTIONS FOR TUNDRA HOMESTEAD#####################################
    ...
    def fill_table_th_rooms(self, *args):            
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_tharareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==1:
                ...
                self.btn_thbrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==2:
                ...
                self.btn_thbaareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def thar_skill(self, *args):
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_th.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_tharasp.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_tharareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def thar_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_th.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_tharas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_tharareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def thar_reg(self, *args):
        ...
        self.btn_clr_th.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_tharas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_tharasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def thbr_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_th.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_thbras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_thbrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def thbr_reg(self, *args):
        ...
        self.btn_clr_th.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_thbras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_thbrasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def thba_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_th.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_thbaas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_thbaareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def thba_reg(self, *args):
        ...
        self.btn_clr_th.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_thbaas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_thbaasp.grid(row=5, column=0, columnspan=2, sticky='ew')
...
###########################################CREATE FUNCTIONS FOR GOLDENHILLS PLANTATION#####################################       
    ...
    def fill_table_gp_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_gparareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==1:
                ...
                self.btn_gpbrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==2:
                ...
                self.btn_gpsrlareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==3:
                ...
                self.btn_gpsrrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpar_skill(self, *args):
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gparasp.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gparareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpar_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gparas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gparareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpar_reg(self, *args):
        ...
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gparas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gparasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpbr_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gpbras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gpbrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpbr_reg(self, *args):
        ...
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gpbras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gpbrasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpsrl_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gpsrlas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gpsrlareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpsrl_reg(self, *args):
        ...
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gpsrlas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gpsrlasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpsrr_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gpsrras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gpsrrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def gpsrr_reg(self, *args):
        ...
        self.btn_clr_gp.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_gpsrras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_gpsrrasp.grid(row=5, column=0, columnspan=2, sticky='ew')
...
#############################################CREATE FUNCTIONS FOR BREEZEHOME########################################
    ...
    def fill_table_b_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_barareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==1:
                ...
                self.btn_blivareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==2:
                ...
                self.btn_blabareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bar_skill(self, *args):
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_b.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_barasp.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_barareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bar_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_b.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_baras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_barareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bar_reg(self, *args):
        ...
        self.btn_clr_b.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_baras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_barasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bliv_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_b.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_blivas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_blivareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bliv_reg(self, *args):
        ...
        self.btn_clr_b.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_blivas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_blivasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def blab_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_b.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_blabas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_blabareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def blab_reg(self, *args):
        ...
        self.btn_clr_b.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_blabas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_blabasp.grid(row=5, column=0, columnspan=2, sticky='ew')
...
##########################################CREATE FUNCTIONS FOR LAKEVIEW MANOR#######################################
    ...
    def fill_table_lm_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_lmareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def lm_skill(self, *args):
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_lm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_lmasp.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_lmareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def lm_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_lm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_lmas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_lmareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def lm_reg(self, *args):
        ...
        self.btn_clr_lm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_lmas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_lmasp.grid(row=5, column=0, columnspan=2, sticky='ew')
...
#########################################CREATE FUNCTIONS FOR BLOODCHILL MANOR######################################
    ...
    def fill_table_bm_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_bmarareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==1:
                ...
                self.btn_bmmb1areg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==2:
                ...
                self.btn_bmmb2areg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==3:
                ...
                self.btn_bmcrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmar_skill(self, *args):
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmarasp.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmarareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmar_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmaras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmarareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmar_reg(self, *args):
        ...
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmaras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmarasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmmb1_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmmb1as.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmmb1areg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmmb1_reg(self, *args):
        ...
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmmb1as.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmmb1asp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmmb2_skill(self, *args):
        ...
        self.btn_bmmb2areg.grid(row=3, column=0, columnspan=2, sticky='ew')
    ...
    def bmmb2_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmmb2as.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmmb2areg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmmb2_reg(self, *args):
        ...
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmmb2as.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmmb2asp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmcr_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmcras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmcrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def bmcr_reg(self, *args):
        ...
        self.btn_clr_bm.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_bmcras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_bmcrasp.grid(row=5, column=0, columnspan=2, sticky='ew')
...
###############################################CREATE FUNCTIONS FOR HENDRAHEIM######################################
    ...
    def fill_table_h_rooms(self, *args):           
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_harareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==1:
                ...
                self.btn_hbrlareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==2:
                ...
                self.btn_hbrrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==3:
                ...
                self.btn_hdaareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def har_skill(self, *args):
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_harasp.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_harareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def har_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_haras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_harareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def har_reg(self, *args):
        ...
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_haras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_harasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hbrl_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hbrlas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hbrlareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hbrl_reg(self, *args):
        ...
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hbrlas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hbrlasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hbrr_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hbrras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hbrrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hbrr_reg(self, *args):
        ...
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hbrras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hbrrasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hda_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hdaas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hdaareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hda_reg(self, *args):
        ...
        self.btn_clr_h.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hdaas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hdaasp.grid(row=5, column=0, columnspan=2, sticky='ew')
...
###############################################CREATE FUNCTIONS FOR HONEYSIDE########################################
    ...
    def fill_table_hs_rooms(self, *args):            
        ...
        if len(idxs_rooms)==1:
            ...
            if idx_room==0:
                ...
                self.btn_hsarareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==1:
                ...
                self.btn_hsbrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
            ...
            if idx_room==2:
                ...
                self.btn_hsbaareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hsar_skill(self, *args):
        ...
        self.btn_open_movebook.grid(row=0, column=2, sticky='ew')
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_hs.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hsarasp.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hsarareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hsar_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_hs.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hsaras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hsarareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hsar_reg(self, *args):
        ...
        self.btn_clr_hs.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hsaras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hsarasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hsbr_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_hs.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hsbras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hsbrareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hsbr_reg(self, *args):
        ...
        self.btn_clr_hs.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hsbras.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hsbrasp.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hsba_spell(self, *args):
        ...
        self.btn_open_delbook.grid(row=0, column=3, sticky='ew')
        self.btn_clr_hs.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hsbaas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hsbaareg.grid(row=5, column=0, columnspan=2, sticky='ew')
    ...
    def hsba_reg(self, *args):
        ...
        self.btn_clr_hs.grid(row=3, column=0, columnspan=2, sticky='ew')
        self.btn_hsbaas.grid(row=4, column=0, columnspan=2, sticky='ew')
        self.btn_hsbaasp.grid(row=5, column=0, columnspan=2, sticky='ew')
